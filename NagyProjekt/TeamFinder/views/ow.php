...
<div class="labelC middleHorizontal">
    <form action="<?php echo route(['page' => 'ow']); ?>" method="POST" enctype="multipart/form-data">
        <div id="top">
            <Table>
                <tr id="searchFill">
                ...
                <tr>
                    ...
                    <td>
                        <select class="textInput" name="minRank" id="minRank">
                            <?php
                            $fn = fopen("Resources\owRanks.txt", "r");
                            $i = 0;
                            while (!feof($fn)) {
                                $result = fgets($fn);
        ...
        <div class="label">
            <table>
                ...
                <td>
                    <input type="checkbox" name="roles[]" value="tank"> Tank
                </td>
                <td>
                    <input type="checkbox" name="roles[]" value="support"> Support
                </td>
                <td>
                    <input type="checkbox" name="roles[]" value="damage"> Damage
                </td>
            </table>
        </div>
